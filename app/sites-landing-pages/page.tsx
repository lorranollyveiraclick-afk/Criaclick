...
export default function SitesLandingPagesPage() {
  ...
  const siteFeatures = [
    {
      icon: Lightbulb,
      title: t('sites_designer_inovador'),
      description: t('sites_designer_inovador_desc')
    },
    {
      icon: Settings,
      title: t('sites_plataforma'),
      description: t('sites_plataforma_desc')
    },
    {
      icon: Search,
      title: t('sites_seo_otimizado'),
      description: t('sites_seo_otimizado_desc')
    },
    {
      icon: Zap,
      title: t('sites_hospedagem_rapida'),
      description: t('sites_hospedagem_rapida_desc')
    },
    {
      icon: Mail,
      title: t('sites_mais_emails'),
      description: t('sites_mais_emails_desc')
    },
    {
      icon: Tag,
      title: t('sites_dominio_gratuito'),
      description: t('sites_dominio_gratuito_desc')
    },
    {
      icon: Lock,
      title: t('sites_site_seguro'),
      description: t('sites_site_seguro_desc')
    },
    {
      icon: Headphones,
      title: t('sites_suporte_especializado'),
      description: t('sites_suporte_especializado_desc')
    }
  ];
  ...
  const landingFeatures = [
    {
      icon: Megaphone,
      title: t('sites_promova_produto'),
      description: t('sites_promova_produto_desc')
    },
    {
      icon: MessageCircle,
      title: t('sites_chat_whatsapp'),
      description: t('sites_chat_whatsapp_desc')
    },
    {
      icon: Search,
      title: t('sites_seo_otimizado'),
    ...
    {
      icon: Monitor,
      title: t('sites_layout_responsivo'),
      description: t('sites_layout_responsivo_desc')
    }
  ];
  ...
  const plans = [
    {
      ...
      popular: false,
      features: [
        t('plan_features_site_landing'),
        t('plan_features_banner_home'),
        t('plan_features_formulario'),
        t('plan_features_localizacao'),
        t('plan_features_redes_sociais'),
        t('plan_features_otimizado_buscas'),
        t('plan_features_ssl'),
        t('plan_features_cache'),
        t('plan_features_lgpd'),
        t('plan_features_10_emails'),
        t('plan_features_responsivo')
      ]
    },
    {
      title: t('plan_prof_title'),
      price: t('plan_prof_price'),
      popular: true,
      features: [
        t('plan_features_site_landing'),
        t('plan_features_banner_home'),
        ...
        t('plan_features_cache'),
        t('plan_features_lgpd'),
        t('plan_features_20_emails'),
        t('plan_features_responsivo'),
        t('plan_features_galeria')
      ]
    },
    {
      ...
      features: [
        ...
        t('plan_features_cache'),
        t('plan_features_lgpd'),
        t('plan_features_50_emails'),
        t('plan_features_responsivo'),
        t('plan_features_galeria'),
        t('plan_features_blog')
      ]
    }
  ];
      ...
      <main className="pt-28 md:pt-32">
                  ...
                  <div className="border border-primary/50 rounded-2xl p-8 bg-card/20 backdrop-blur-sm shadow-glow">
                    ...
                    <div className="aspect-square bg-gradient-dark rounded-xl relative overflow-hidden">
                      ...
                      <div className="absolute bottom-4 right-4 bg-card/80 backdrop-blur border border-primary/30 rounded-lg p-3">
                        <div className="text-xs text-muted-foreground">Working Team</div>
                      </div>
                    </div>
              ...
              <div className="space-y-8">
                <div className="space-y-6">
                  ...
                  <p className="text-muted-foreground text-lg leading-relaxed max-w-md">
                    Descubra como nossa equipe especializada transforma suas ideias em sites e landing pages de alta performance.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="md:ml-12 lg:ml-16">
          ...
          <section className="px-8 py-16 bg-background">
            <div className="max-w-7xl mx-auto">
              <div className="text-center space-y-6 mb-16">
                <h2 className="text-4xl font-bold text-primary">{t('sites_criacao_sites')}</h2>
                <p className="text-muted-foreground text-lg max-w-3xl mx-auto leading-relaxed">
                  {t('sites_criacao_sites_subtitle')}
                </p>
              </div>
          ...
          <section className="px-8 py-16 bg-card/5">
            <div className="max-w-7xl mx-auto">
              <div className="text-center space-y-6 mb-16">
                <h2 className="text-4xl font-bold text-primary">{t('sites_landing_pages')}</h2>
                <p className="text-muted-foreground text-lg max-w-3xl mx-auto leading-relaxed">
                  {t('sites_criacao_sites_subtitle')}
                </p>
              </div>
          ...
          <section className="px-8 py-16 bg-background">
            <div className="max-w-7xl mx-auto">
              <div className="text-center space-y-6 mb-16">
                <h2 className="text-4xl font-bold text-primary">{t('sites_melhores_planos')}</h2>
                <p className="text-muted-foreground text-lg max-w-3xl mx-auto leading-relaxed">
                  {t('sites_melhores_planos_subtitle')}
                </p>
              </div>
          ...
          <section className="px-8 py-16 bg-card/5">
            <div className="max-w-7xl mx-auto text-center space-y-8">
              <div className="space-y-6">
                <h2 className="text-4xl font-bold text-primary">{t('sites_comece_hoje')}</h2>
                <p className="text-muted-foreground text-lg max-w-3xl mx-auto leading-relaxed">
                  {t('sites_comece_hoje_text')}
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="px-8 py-16 bg-background">
            <div className="max-w-7xl mx-auto">
              <div className="grid md:grid-cols-2 gap-12 items-start">
                ...
                <div className="space-y-8">
                  <div className="space-y-6">
                    <h2 className="text-4xl font-bold text-primary">{t('sites_entre_contato')}</h2>
                    <p className="text-muted-foreground text-lg leading-relaxed">
                      {t('sites_entre_contato_text')}
                    </p>
                  </div>
